...
class TaskWatcher:
    ...
    def do_watch(request, **kwargs):
        ...
        #         message_url='https://fosun.focuth.com/exerland/questionnaireDetail?questionnaire_id=23',
        #         pc_message_url='https://fosun.focuth.com/exerland/questionnaireDetail?questionnaire_id=23',
        #     ),
