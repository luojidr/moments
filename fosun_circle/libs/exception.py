from ..constants.enums.code_message import CodeMessageEnum
...
class DingMsgBodyFieldError(BaseError):
    def __init__(self, msg_type):
        self.code = CodeMessageEnum.DING_MSG_BODY_FIELD_ERROR.code
        self.msg = CodeMessageEnum.DING_MSG_BODY_FIELD_ERROR.message.format(msg_type=msg_type)
        BaseError.__init__(self, self.msg, self.code)
...
class InvalidTokenError(BaseError):
    def __init__(self, msg):
        self.code = CodeMessageEnum.INVALID_TOKEN.code
        self.msg = msg or CodeMessageEnum.INVALID_TOKEN.message
        BaseError.__init__(self, self.msg, self.code)


class ExpiredTokenError(BaseError):
    def __init__(self, msg):
        self.code = CodeMessageEnum.EXPIRED_TOKEN.code
        self.msg = msg or CodeMessageEnum.EXPIRED_TOKEN.message
        BaseError.__init__(self, self.msg, self.code)


class UriForbiddenError(BaseError):
    def __init__(self, msg):
        self.code = CodeMessageEnum.URI_FORBIDDEN.code
        self.msg = msg or CodeMessageEnum.URI_FORBIDDEN.message
        BaseError.__init__(self, self.msg, self.code)
